        ...
        <div
          ...
          <NumberInput
            ...
            className={clsx(
              ...
              {
                [clsx(
                  { 'border-phoenixCinnabar': process.env.REACT_APP_RELAY_CHAIN_NAME === POLKADOT },
                  { 'dark:border-phoenixThunderbird': process.env.REACT_APP_RELAY_CHAIN_NAME === KUSAMA },
                  { 'text-phoenixCinnabar': process.env.REACT_APP_RELAY_CHAIN_NAME === POLKADOT },
                  { 'text-phoenixThunderbird': process.env.REACT_APP_RELAY_CHAIN_NAME === KUSAMA }
                )]: error
              }
            )}
            name={name}
